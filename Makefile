...
Objects0=$(IntermediateDirectory)/circular_buffer.c$(ObjectSuffix) $(IntermediateDirectory)/MCAHP_test_lib.c$(ObjectSuffix) 
...
$(IntermediateDirectory)/MCAHP_test_lib.c$(ObjectSuffix): src/MCAHP_test_lib.c $(IntermediateDirectory)/MCAHP_test_lib.c$(DependSuffix)
	$(CC) $(SourceSwitch) "src/MCAHP_test_lib.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/MCAHP_test_lib.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/MCAHP_test_lib.c$(DependSuffix): src/MCAHP_test_lib.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/MCAHP_test_lib.c$(ObjectSuffix) -MF$(IntermediateDirectory)/MCAHP_test_lib.c$(DependSuffix) -MM src/MCAHP_test_lib.c

$(IntermediateDirectory)/MCAHP_test_lib.c$(PreprocessSuffix): src/MCAHP_test_lib.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/MCAHP_test_lib.c$(PreprocessSuffix) src/MCAHP_test_lib.c
