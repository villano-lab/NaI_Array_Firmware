...
SCILIB int REG_TK_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_TK, handle);
}
SCILIB int REG_TK_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_TK, handle);
}
SCILIB int REG_TM_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_TM, handle);
}
SCILIB int REG_TM_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_TM, handle);
}
...
SCILIB int REG_decovM_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_decovM, handle);
}
SCILIB int REG_decovM_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_decovM, handle);
}
...
SCILIB int REG_blen_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_blen, handle);
}
SCILIB int REG_blen_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_blen, handle);
}
SCILIB int REG_blinib_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_blinib, handle);
}
SCILIB int REG_blinib_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_blinib, handle);
}
SCILIB int REG_samplepos_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_samplepos, handle);
}
SCILIB int REG_samplepos_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_samplepos, handle);
}
