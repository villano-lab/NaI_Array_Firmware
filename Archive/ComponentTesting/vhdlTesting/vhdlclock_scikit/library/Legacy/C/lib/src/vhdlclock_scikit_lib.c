...
#include  "vhdlclock_scikit_lib.h"
...
SCILIB int REG_greater_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_greater, handle);
}
SCILIB int REG_greater_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_greater, handle);
}
SCILIB int REG_Tx_Done_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_Tx_Done, handle);
}
SCILIB int REG_Tx_Done_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_Tx_Done, handle);
}
SCILIB int REG_Tx_Done_Ever_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_Tx_Done_Ever, handle);
}
SCILIB int REG_Tx_Done_Ever_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_Tx_Done_Ever, handle);
}
SCILIB int REG_FM_Out_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_FM_Out, handle);
}
SCILIB int REG_FM_Out_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_FM_Out, handle);
}
SCILIB int REG_to_encode_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_to_encode, handle);
}
SCILIB int REG_to_encode_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_to_encode, handle);
}
SCILIB int REG_timing_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_timing, handle);
}
SCILIB int REG_timing_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_timing, handle);
}
...
{
     return __abstracted_reg_read(val, SCI_REG_freq, handle);
}
