...
{
     return __abstracted_reg_read(val, SCI_REG_AN_IN, handle);
}
SCILIB int REG_AN_IN_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_AN_IN, handle);
}
SCILIB int REG_CNTR_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_CNTR, handle);
}
SCILIB int REG_CNTR_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_CNTR, handle);
}
