...
import NaIArrayTest3_RegisterFile
from ctypes import *
import array
import numpy as np
...
def REG_integrals3_GET(handle):
    [err, data] = __abstracted_reg_read(NaIArrayTest3_RegisterFile.SCI_REG_integrals3, handle)
    return err, data

def REG_integrals3_SET(data, handle):
    err = __abstracted_reg_write(data, NaIArrayTest3_RegisterFile.SCI_REG_integrals3, handle)
    return err
