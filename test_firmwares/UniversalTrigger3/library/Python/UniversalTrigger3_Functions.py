...
import UniversalTrigger3_RegisterFile
from ctypes import *
import array
import numpy as np
...
def REG_ratereset_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_ratereset, handle)
    return err, data

def REG_ratereset_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_ratereset, handle)
    return err

def REG_thrsh_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_thrsh, handle)
    return err, data

def REG_thrsh_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_thrsh, handle)
    return err

def REG_polarity_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_polarity, handle)
    return err, data

def REG_polarity_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_polarity, handle)
    return err

def REG_top_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_top, handle)
    return err, data
...
def REG_inhib_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_inhib, handle)
    return err

def REG_delay_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_delay, handle)
    return err, data

def REG_delay_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_delay, handle)
    return err

def REG_disable_det_0_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_0, handle)
    return err, data

def REG_disable_det_0_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_0, handle)
    return err

def REG_disable_det_1_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_1, handle)
    return err, data

def REG_disable_det_1_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_1, handle)
    return err

def REG_disable_det_2_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_2, handle)
    return err, data

def REG_disable_det_2_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_2, handle)
    return err

def REG_disable_det_3_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_3, handle)
    return err, data

def REG_disable_det_3_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_3, handle)
    return err

def REG_disable_det_4_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_4, handle)
    return err, data

def REG_disable_det_4_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_4, handle)
    return err

def REG_disable_det_5_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_5, handle)
    return err, data

def REG_disable_det_5_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_5, handle)
    return err

def REG_disable_det_6_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_6, handle)
    return err, data

def REG_disable_det_6_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_6, handle)
    return err

def REG_disable_det_7_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_7, handle)
    return err, data

def REG_disable_det_7_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_7, handle)
    return err

def REG_disable_det_8_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_8, handle)
    return err, data

def REG_disable_det_8_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_8, handle)
    return err

def REG_disable_det_9_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_9, handle)
    return err, data

def REG_disable_det_9_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_9, handle)
    return err

def REG_disable_det_10_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_10, handle)
    return err, data

def REG_disable_det_10_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_10, handle)
    return err

def REG_disable_det_11_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_11, handle)
    return err, data

def REG_disable_det_11_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_11, handle)
    return err

def REG_disable_det_12_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_12, handle)
    return err, data

def REG_disable_det_12_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_12, handle)
    return err

def REG_disable_det_13_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_13, handle)
    return err, data

def REG_disable_det_13_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_13, handle)
    return err

def REG_disable_det_14_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_14, handle)
    return err, data

def REG_disable_det_14_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_14, handle)
    return err

def REG_disable_det_15_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_15, handle)
    return err, data

def REG_disable_det_15_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_15, handle)
    return err

def REG_disable_det_16_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_16, handle)
    return err, data

def REG_disable_det_16_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_16, handle)
    return err

def REG_disable_det_17_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_17, handle)
    return err, data

def REG_disable_det_17_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_17, handle)
    return err

def REG_disable_det_18_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_18, handle)
    return err, data

def REG_disable_det_18_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_18, handle)
    return err

def REG_disable_det_19_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_19, handle)
    return err, data

def REG_disable_det_19_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_19, handle)
    return err

def REG_disable_det_20_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_20, handle)
    return err, data

def REG_disable_det_20_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_20, handle)
    return err

def REG_disable_det_21_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_21, handle)
    return err, data

def REG_disable_det_21_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_21, handle)
    return err

def REG_disable_det_22_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_22, handle)
    return err, data

def REG_disable_det_22_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_22, handle)
    return err

def REG_disable_det_23_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_23, handle)
    return err, data

def REG_disable_det_23_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_23, handle)
    return err

def REG_disable_det_24_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_disable_det_24, handle)
    return err, data

def REG_disable_det_24_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_disable_det_24, handle)
    return err

def REG_gate_l_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_gate_l, handle)
    return err, data

def REG_gate_l_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_gate_l, handle)
    return err

def REG_gate_u_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_gate_u, handle)
    return err, data

def REG_gate_u_SET(data, handle):
    err = __abstracted_reg_write(data, UniversalTrigger3_RegisterFile.SCI_REG_gate_u, handle)
    return err

def REG_fifo_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_fifo, handle)
    return err, data
...
def REG_read_GET(handle):
    [err, data] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_read, handle)
    return err, data
...
def OSCILLOSCOPE_Oscilloscope_0_START(handle):
    err = __abstracted_reg_write(0, UniversalTrigger3_RegisterFile.SCI_REG_Oscilloscope_0_CONFIG_ARM, handle)
    if (err != 0):
       return False
    err = __abstracted_reg_write(1, UniversalTrigger3_RegisterFile.SCI_REG_Oscilloscope_0_CONFIG_ARM, handle)
    if (err != 0):
       return False
    return True

def OSCILLOSCOPE_Oscilloscope_0_SET_DECIMATOR(OscilloscopeDecimator, handle):
    err = __abstracted_reg_write(OscilloscopeDecimator, UniversalTrigger3_RegisterFile.SCI_REG_Oscilloscope_0_CONFIG_DECIMATOR, handle)
    return err

def OSCILLOSCOPE_Oscilloscope_0_SET_PRETRIGGER(OscilloscopePreTrigger, handle):
    err = __abstracted_reg_write(OscilloscopePreTrigger, UniversalTrigger3_RegisterFile.SCI_REG_Oscilloscope_0_CONFIG_PRETRIGGER, handle)
    return err

def OSCILLOSCOPE_Oscilloscope_0_SET_TRIGGER_LEVEL(OscilloscopeTriggerLevel, handle):
    err = __abstracted_reg_write(OscilloscopeTriggerLevel, UniversalTrigger3_RegisterFile.SCI_REG_Oscilloscope_0_CONFIG_TRIGGER_LEVEL, handle)
    return err
...
def OSCILLOSCOPE_Oscilloscope_0_SET_TRIGGER_MODE(OscilloscopeTriggerMode, OscilloscopeTriggerChannel, OscilloscopeTriggerEdge, handle):
    ...
    err = __abstracted_reg_write(triggermode, UniversalTrigger3_RegisterFile.SCI_REG_Oscilloscope_0_CONFIG_TRIGGER_MODE, handle)
    return err

def OSCILLOSCOPE_Oscilloscope_0_GET_STATUS(handle):
    [err, status] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_Oscilloscope_0_READ_STATUS, handle)
    return err, status

def OSCILLOSCOPE_Oscilloscope_0_GET_POSITION(handle):
    [err, position] = __abstracted_reg_read(UniversalTrigger3_RegisterFile.SCI_REG_Oscilloscope_0_READ_POSITION, handle)
    return err, position

def OSCILLOSCOPE_Oscilloscope_0_GET_DATA(timeout_ms, handle):
    [err, data, read_data, valid_data] = __abstracted_mem_read(24576, UniversalTrigger3_RegisterFile.SCI_REG_Oscilloscope_0_FIFOADDRESS, timeout_ms, handle)
    return err, data, read_data, valid_data
...
def RATE_METER_RateMeter_0_GET_DATA(channels, timeout_ms, handle):
    [err, data, read_data, valid_data] = __abstracted_mem_read(channels, UniversalTrigger3_RegisterFile.SCI_REG_RateMeter_0_FIFOADDRESS, timeout_ms, handle)
    return err, data, read_data, valid_data
...
def RATE_METER_RateMeter_0_GET_DATA_COUNTS(channels, timeout_ms, handle):
    [err, data, read_data, valid_data] = __abstracted_mem_read(channels, UniversalTrigger3_RegisterFile.SCI_REG_RateMeter_0_FIFOADDRESS + 512, timeout_ms, handle)
    return err, data, read_data, valid_data
