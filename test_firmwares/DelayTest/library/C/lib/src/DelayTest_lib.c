...
{
     return __abstracted_reg_read(val, SCI_REG_trigpol, handle);
}
SCILIB int REG_trigpol_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_trigpol, handle);
}
SCILIB int REG_inhibtop_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_inhibtop, handle);
}
SCILIB int REG_inhibtop_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_inhibtop, handle);
}
