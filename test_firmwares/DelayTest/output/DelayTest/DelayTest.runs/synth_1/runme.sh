...
HD_PWD='C:/OpenHardware/UserProject/NaI_Array_Firmware/test_firmwares/DelayTest/output/DelayTest/DelayTest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_DelayTest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_DelayTest.tcl
