...
HD_PWD='C:/OpenHardware/UserProject/NaI_Array_Firmware/test_firmwares/DelayTest/output/DelayTest/DelayTest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_DelayTest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_DelayTest.tcl -notrace
