...
#include  "UniversalTrigger3B_lib.h"
...
{
     return __abstracted_reg_read(val, SCI_REG_orcheck, handle);
}
...
SCILIB int REG_custom_full_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_custom_full, handle);
}
SCILIB int REG_custom_full_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_custom_full, handle);
}
//-----------------------------------------------------------------
//-
