...
HD_PWD='C:/OpenHardware/UserProject/NaI_Array_Firmware/test_firmwares/TrigTest1/output/TrigTest1/TrigTest1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_TrigTest1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_TrigTest1.tcl
