...
HD_PWD='C:/OpenHardware/UserProject/NaI_Array_Firmware/test_firmwares/TrigTest1/output/TrigTest1/TrigTest1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_TrigTest1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_TrigTest1.tcl -notrace
