...
HD_PWD='C:/OpenHardware/UserProject/NaI_Array_Firmware/test_firmwares/TrigTest2/output/TrigTest2/TrigTest2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_TrigTest2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_TrigTest2.tcl -notrace
