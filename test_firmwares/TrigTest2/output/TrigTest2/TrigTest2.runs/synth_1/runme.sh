...
HD_PWD='C:/OpenHardware/UserProject/NaI_Array_Firmware/test_firmwares/TrigTest2/output/TrigTest2/TrigTest2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_TrigTest2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_TrigTest2.tcl
