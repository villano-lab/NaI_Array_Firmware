...
HD_PWD='C:/OpenHardware/UserProject/NaI_Array_Firmware/test_firmwares/PuBeTrigger6/output/PuBeTrigger6/PuBeTrigger6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_PuBeTrigger6.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_PuBeTrigger6.tcl -notrace
