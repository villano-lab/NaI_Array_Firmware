...
HD_PWD='C:/OpenHardware/UserProject/NaI_Array_Firmware/test_firmwares/PuBeTrigger6/output/PuBeTrigger6/PuBeTrigger6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_PuBeTrigger6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_PuBeTrigger6.tcl
