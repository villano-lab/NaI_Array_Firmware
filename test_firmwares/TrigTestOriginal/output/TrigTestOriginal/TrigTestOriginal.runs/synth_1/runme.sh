...
HD_PWD='C:/OpenHardware/UserProject/NaI_Array_Firmware/test_firmwares/TrigTestOriginal/output/TrigTestOriginal/TrigTestOriginal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_TrigTestOriginal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_TrigTestOriginal.tcl
