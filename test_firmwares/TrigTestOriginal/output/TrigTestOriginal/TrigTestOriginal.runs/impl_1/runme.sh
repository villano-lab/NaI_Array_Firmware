...
HD_PWD='C:/OpenHardware/UserProject/NaI_Array_Firmware/test_firmwares/TrigTestOriginal/output/TrigTestOriginal/TrigTestOriginal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_TrigTestOriginal.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_TrigTestOriginal.tcl -notrace
