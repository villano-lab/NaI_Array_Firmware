...
HD_PWD='C:/OpenHardware/UserProject/NaI_Array_Firmware/test_firmwares/TrigTest0/output/TrigTest0/TrigTest0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_TrigTest0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_TrigTest0.tcl -notrace
