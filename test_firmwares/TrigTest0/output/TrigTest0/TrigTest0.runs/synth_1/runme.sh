...
HD_PWD='C:/OpenHardware/UserProject/NaI_Array_Firmware/test_firmwares/TrigTest0/output/TrigTest0/TrigTest0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_TrigTest0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_TrigTest0.tcl
