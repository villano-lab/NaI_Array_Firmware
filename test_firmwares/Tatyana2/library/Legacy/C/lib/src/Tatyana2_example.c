...
int main(int argc, char* argv[])
{
	...
	int32_t size_osc = 4096;
	uint32_t read_analog[4096];
	uint32_t read_digital0[4096];
	uint32_t read_digital1[4096];
	uint32_t read_digital2[4096];
	uint32_t read_digital3[4096];
	int Osc_Events = 10;
	int e = 0;
	while (e<Osc_Events)
	{
