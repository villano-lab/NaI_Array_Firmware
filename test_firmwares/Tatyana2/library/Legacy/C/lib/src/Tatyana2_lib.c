...
//-
//- Take as input the downloaded buffer and decode the the different track for each channels. Channel order is the following: [0...4095] Channel 1, [4096...8191] Channel2
//- 
//- 
//-
//- ARGUMENTS:
