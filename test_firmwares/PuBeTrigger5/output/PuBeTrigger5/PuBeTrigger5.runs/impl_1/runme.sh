...
HD_PWD='C:/OpenHardware/UserProject/PuBeTrigger5/output/PuBeTrigger5/PuBeTrigger5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_PuBeTrigger5.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_PuBeTrigger5.tcl -notrace
