...
HD_PWD='C:/OpenHardware/UserProject/PuBeTrigger5/output/PuBeTrigger5/PuBeTrigger5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_PuBeTrigger5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_PuBeTrigger5.tcl
