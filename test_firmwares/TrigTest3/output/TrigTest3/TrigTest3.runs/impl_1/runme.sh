...
HD_PWD='C:/OpenHardware/UserProject/NaI_Array_Firmware/test_firmwares/TrigTest3/output/TrigTest3/TrigTest3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_TrigTest3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_TrigTest3.tcl -notrace
