...
HD_PWD='C:/OpenHardware/UserProject/NaI_Array_Firmware/test_firmwares/TrigTest3/output/TrigTest3/TrigTest3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_TrigTest3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_TrigTest3.tcl
