...
HD_PWD='C:/OpenHardware/UserProject/NaI_Array_Firmware/test_firmwares/TrigTest4/output/TrigTest4/TrigTest4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_TrigTest4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_TrigTest4.tcl
