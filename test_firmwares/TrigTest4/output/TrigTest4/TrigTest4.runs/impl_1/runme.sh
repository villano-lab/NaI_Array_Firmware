...
HD_PWD='C:/OpenHardware/UserProject/NaI_Array_Firmware/test_firmwares/TrigTest4/output/TrigTest4/TrigTest4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_TrigTest4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_TrigTest4.tcl -notrace
