...
$(OutputFile): $(IntermediateDirectory)/.d $(Objects) 
	...
	@echo rebuilt > ".build-debug/libSCIDK"
...
$(IntermediateDirectory)/src_FTDI_CPP_DLL.cpp$(ObjectSuffix): src/FTDI_CPP_DLL.cpp $(IntermediateDirectory)/src_FTDI_CPP_DLL.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "src/FTDI_CPP_DLL.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_FTDI_CPP_DLL.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_SCIDK_API_C.cpp$(ObjectSuffix): src/SCIDK_API_C.cpp $(IntermediateDirectory)/src_SCIDK_API_C.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "src/SCIDK_API_C.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_SCIDK_API_C.cpp$(ObjectSuffix) $(IncludePath)
