...
int main(int argc, char* argv[]){
	...
	adddevice = SCIDK_ConnectUSB(BOARD_SERIAL_NUMBER,(NI_HANDLE*)_sdk);
	//adddevice = connect_staticaddr(0,_sdk);
	std::cout << "dev size: ";
	...
	NI_WriteReg(0,0xFFFFFFFF,(NI_HANDLE*)_sdk);
        NI_ReadReg(&value,0xFFFFFFFF,(NI_HANDLE*)_sdk);
