...
int main(int argc, char* argv[])
{
	...
	inhib_q = __abstracted_reg_write(inhib,SCI_REG_trig_inhib,(NI_HANDLE*)_sdk);//Set number of clock ticks to inhibit data by
	...
	polarity_q = __abstracted_reg_write(polarity,SCI_REG_trig_polarity,(NI_HANDLE*)_sdk);//Set polarity to negative
