...
def REG_received_GET(handle):
    [err, data] = __abstracted_reg_read(R76Replica_RegisterFile.SCI_REG_received, handle)
    return err, data
...
def OSCILLOSCOPE_Oscilloscope_1_GET_DATA(timeout_ms, handle):
    [err, data, read_data, valid_data] = __abstracted_mem_read(5120, R76Replica_RegisterFile.SCI_REG_Oscilloscope_1_FIFOADDRESS, timeout_ms, handle)
    return err, data, read_data, valid_data
