...
#define SCI_REG_thrsh_CH0 0x60008
#define SCI_REG_thrsh_CH1 0x60009

#define SCI_REG_top_CH0 0x62009
#define SCI_REG_top_CH1 0x6200A

#define SCI_REG_base_CH0 0x60014
#define SCI_REG_base_CH1 0x60015

#define SCI_REG_RateMeter_0_FIFOADDRESS 0x30000

#define SCI_REG_trig_polarity 0x1
#define SCI_REG_trig_inhib 0x2
#define SCI_REG_trig_gate_l 0x3
#define SCI_REG_trig_gate_u 0x4
#define SCI_REG_trig_delay 0x5

#define SCI_REG_int_time 0x6000C
#define SCI_REG_int_pre 0x6000D
...
#define SCI_REG_Oscilloscope_1_CONFIG_TRIGGER_MODE 0x62002
#define SCI_REG_Oscilloscope_1_CONFIG_PRETRIGGER 0x62003
#define SCI_REG_Oscilloscope_1_CONFIG_TRIGGER_LEVEL 0x62004
