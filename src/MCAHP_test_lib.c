...
SCILIB int REG_THR_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_THR, handle);
}
SCILIB int REG_THR_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_THR, handle);
}
SCILIB int REG_TRAP_K_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_TRAP_K, handle);
}
SCILIB int REG_TRAP_K_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_TRAP_K, handle);
}
SCILIB int REG_TRAP_M_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_TRAP_M, handle);
}
SCILIB int REG_TRAP_M_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_TRAP_M, handle);
}
SCILIB int REG_DECONV_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_DECONV, handle);
}
SCILIB int REG_DECONV_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_DECONV, handle);
}
...
SCILIB int REG_BL_LEN_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_BL_LEN, handle);
}
SCILIB int REG_BL_LEN_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_BL_LEN, handle);
}
SCILIB int REG_BL_INIB_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_BL_INIB, handle);
}
SCILIB int REG_BL_INIB_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_BL_INIB, handle);
}
SCILIB int REG_SAMPLE_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_SAMPLE, handle);
}
SCILIB int REG_SAMPLE_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_SAMPLE, handle);
}
...
SCILIB int REG_K_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_K, handle);
}
SCILIB int REG_K_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_K, handle);
}
SCILIB int REG_M_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_M, handle);
}
SCILIB int REG_M_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_M, handle);
}
//-----------------------------------------------------------------
//-
